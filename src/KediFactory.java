...
public class  KediFactory {
    public Kedi createKedi(ShoesNames shoesName) {
        ...
        if (shoesName == null) {
            ...
            return new Vans(random.nextInt(1000000), random.nextInt(100), random.nextInt(100), getRandomColor(),
                    getRandomTypeKedi(), random.nextInt(30000), random.nextInt(10000)
            );
        } else if (shoesName == ShoesNames.CONVERS) {
            return new Convers(random.nextInt(1000000), random.nextInt(100), random.nextInt(100), getRandomColor(),
